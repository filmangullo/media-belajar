...
<div class="whole-wrap">
    <div class="container">
        <div class="section-top-border">
            ...
            <form action="{{route('update_tugas.tugaspanel', $tugas->id)}}" method="post">
              {{ csrf_field() }}
              <textarea id="summernote" name="tugas" required>{!! $tugas->tugas !!}</textarea>
              ...
              <div class="section-top-border">
                <div class="input-group">
                  ...
                  <textarea class="form-control" aria-label="With textarea" name="keterangan" required>{!! $tugas->keterangan !!}</textarea>
                </div>
              </div>
